...
<?php foreach ($barang as $barang_item): ?>
    ...
    <td>
        ...
        <a href="<?php echo site_url('barang/edit/'.$barang_item['id']); ?>">Update</a> |                  
        <a href="<?php echo site_url('barang/delete/'.$batang_item['id']); ?>" onClick="return confirm('Are you sure you want to delete?')">Delete</a>
    </td>
    </tr>
<?php endforeach; ?>
</table>
